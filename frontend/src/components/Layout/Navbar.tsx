...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-[1000] h-16 sm:h-[80px] flex items-center justify-between px-3 sm:px-6 lg:px-10 bg-[#050810]/20 backdrop-blur-sm border-b border-white/5 transition-transform duration-300 ${show ? 'translate-y-0' : '-translate-y-full'}`}>
